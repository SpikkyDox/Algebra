...
$vhdxSourcePath = "\\SCCMSHARE\ASBP-ispit"
$vhdxDestFolder = "D$\ASBP-backup"
$destHostsFile = "C:\GitHub\Hosts\ZG-D11.txt"
...
foreach ($destHost in $destHosts) {
    ...
    # Output a message indicating the status of the copy operationwaa
